...
//monelbil
Route::get('/monetbil-pay', 'MonetbilController@payment')->name('monetbil-payment');
Route::get('/monetbil-callback', 'MonetbilController@callback')->name('monetbil-callback');
Route::post('/monetbil-notification', 'MonetbilController@notification')->name('monetbil-notification');
