        ...
        <div class="for-card col-md-4">
            <div class="card bg--1 h-100">
                ...
                <div class="card-footer pt-0 bg-transparent">
                    ...
                    <a tabindex="0" class="btn btn-- bg--title h--45px w-100" role="button" data-toggle="popover" data-trigger="focus" title="{{translate('messages.warning_missing_bank_info')}}" data-content="{{translate('messages.warning_add_bank_info')}}">{{translate('messages.request_withdraw')}}</a>
                    @else
                    <a class="btn btn-- bg--title h--45px w-100" href="javascript:" data-toggle="modal" data-target="#balance-modal">{{translate('messages.request_withdraw')}}</a>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ translate('messages.withdraw_request')}}</h5>
                </div>
