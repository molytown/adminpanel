...
<head>
    ...
    @php
        ...
        $app_title_name = \App\CentralLogics\Helpers::get_business_settings('login_title_name', false);
        $app_tag_line = \App\CentralLogics\Helpers::get_business_settings('login_tag_line', false);
...
<main id="content" role="main" class="main auth-bg">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between">
        <div class="auth-content">
            <div class="content">
                <h2 class="title text-capitalize">{{$app_title_name}}</h2>
        ...
        <div class="auth-wrapper">
            <div class="auth-wrapper-body">
                @php($systemlogo=\App\Models\BusinessSetting::where(['key'=>'auth_logo'])->first())
                @php ($systemlogo= isset($systemlogo) ? $systemlogo->value : '' )
                <a class="auth-logo mb-5" href="javascript:">
                    <img class="z-index-2" onerror="this.src='{{asset('public/assets/admin/img/160x160/img1.jpg')}}'"
