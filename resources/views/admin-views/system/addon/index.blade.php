                        ...
                        <div class="item">
                            <div class="mb-20">
                                <div class="">
                                    ...
                                    {{-- <h5 class="modal-title"> {{ translate('Get_your_zip_file_from_the_purchased_addon_and_upload_it_and_activate_addon_with_your_Codecanyon_username_and_purchase_code') }}.
                                    </h5> --}}
                                        <ol>
                        ...
                        {{-- <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="{{asset('public/assets/admin/img/slider-3.png')}}" loading="lazy" alt="" class="dark-support rounded mb-4 mw-100">
                                    <h5 class="modal-title">{{ translate('Now_you’ll_be_successfully_able_to_use_the_addon_for_your_website') }}</h5>
                                    <br>
                                    <h6> {{ translate('N:B_You_can_upload_only_addon_templates') }}</h6>
                                </div>
