...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title"><i class="tio-filter-list"></i> {{ translate('messages.New_joining_request') }}</h1>
            <!-- Resturent List -->
        ...
        <div class="d-flex flex-wrap mb-4" style="gap:15px">
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('admin.restaurant.pending')}}">{{translate('messages.not_approved')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('admin.restaurant.denied')}}"  aria-disabled="true">{{translate('messages.denied')}}</a>
                    </li>
                </ul>
                <!-- End Nav -->
            </div>
