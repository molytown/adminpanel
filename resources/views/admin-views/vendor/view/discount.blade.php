    ...
    <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('admin.vendor.view', ['restaurant'=>$restaurant->id, 'tab'=> 'discount'])}}"  aria-disabled="true">{{translate('discounts')}}</a>
                </li>
                <li class="nav-item">
            ...
            <div class="row gy-3">
                ...
                <div class="col-md-4 text-center text-md-left">
                    <div class="discount-item style-2">
                        ...
                        <ul class="list-unstyled list-unstyled-py-3 text-dark">
                            <li class="p-0 pt-1 justify-content-center justify-content-md-start">
                                <span>{{translate('messages.max')}} {{translate('messages.purchase')}} {{translate('messages.discount')}} :</span> <strong>{{\App\CentralLogics\Helpers::format_currency($restaurant->discount?$restaurant->discount->max_discount:0 ,$zone_currency)}}</strong></li>
                            <li class="p-0 pt-1 justify-content-center justify-content-md-start">
                                <span>{{translate('messages.min')}} {{translate('messages.purchase')}} {{translate('messages.amount')}} :</span> <strong>{{\App\CentralLogics\Helpers::format_currency($restaurant->discount?$restaurant->discount->min_purchase:0 ,$zone_currency)}}</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
