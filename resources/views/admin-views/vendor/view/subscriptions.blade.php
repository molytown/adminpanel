                    ...
                    <div class="__plan-item">
                        ...
                        <div class="__plan">
                            ...
                            <ul class="plan-info">
                                @if ($package->pos)
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/public/assets/landing/img/check2.svg')}}" alt=""> {{ translate('messages.POS') }}
                                </li>
                                @endif
                                ...
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/public/assets/landing/img/check2.svg')}}" alt=""> {{ translate('messages.Unlimited_Orders') }}
                                </li>
                                @else
                                <li>
                                ...
                                <li>
                                    <img class="plan-info-icon" src="{{asset('/public/assets/landing/img/check2.svg')}}" alt=""> {{ translate('messages.Unlimited_uploads') }}
                                </li>
                                @else
                                <li>
