    ...
    <div class="modal-body">
        <div class="d-flex flex-row">
            ...
            <div class="details pl-2">
                ...
                @endif
                <!-- Product panels-->
                {{--<div class="ml-n-1 sharethis-inline-share-buttons"></div>--}}
            </div>
        </div>
        <div class="row pt-2">
            <div class="col-12">
                ...
                <form id="add-to-cart-form" class="mb-2">
                    ...
                    @foreach (\App\Models\AddOn::whereIn('id', $add_ons)->active()->get() as $key => $add_on)
                        <div class="flex-column pb-2">
                            ...
                            <label class="d-flex align-items-center btn btn-sm check-label mx-1 addon-input"
                                for="addon{{ $key }}">{{ Str::limit($add_on->name, 20, '...') }} <br> {{ \App\CentralLogics\Helpers::format_currency($add_on->price,$zone_currency) }}</label>
                    ...
                    <div class="d-flex justify-content-center mt-2">
                        <button class="btn btn--primary w-40p h--45px"
