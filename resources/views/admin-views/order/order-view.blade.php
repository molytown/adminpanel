                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <div class="mt-2">
                        @php
                            ...
                            $zone_currency=$order->zone_currency ?? null;
                        @endphp
                                        ...
                                        <td>
                                            <div class="media media--sm">
                                                ...
                                                <div class="media-body">
                                                    <div>
                                                        <strong class="line--limit-1"> {{ $detail->food['name'] }}</strong>
                                            ...
                                            <div class="media media--sm">
                                                ...
                                                <div class="media-body">
                                                    <div>
                                                        ...
                                                        @endif
                                                        <h6>
                                                            {{ $detail['quantity'] }} x {{ \App\CentralLogics\Helpers::format_currency($detail['price'], $zone_currency) }}
                                                        </h6>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-9 col-lg-8 initial-39-3">
                                <dl class="row text-sm-right">
                                    ...
                                    <dd class="col-6 text-right">
                                        {{ \App\CentralLogics\Helpers::format_currency($product_price, $zone_currency) }}</dd>
                                    <dt class="col-6">{{ translate('messages.addon') }}
                                        {{ translate('messages.cost') }}:
                                    </dt>
                                    <dd class="col-6 text-right">
                                        {{ \App\CentralLogics\Helpers::format_currency($total_addon_price, $zone_currency) }}
                                        <hr>
                                    </dd>

                                    <dt class="col-6">{{ translate('messages.subtotal') }}:</dt>
                                    <dd class="col-6 text-right">
                                        {{ \App\CentralLogics\Helpers::format_currency($product_price + $total_addon_price, $zone_currency) }}
                                    </dd>
                                    <dt class="col-6">{{ translate('messages.discount') }}:</dt>
                                    <dd class="col-6 text-right">
                                        - {{ \App\CentralLogics\Helpers::format_currency($restaurant_discount_amount, $zone_currency) }}
                                    </dd>
                                    <dt class="col-6">{{ translate('messages.coupon') }}
                                        {{ translate('messages.discount') }}:</dt>
                                    <dd class="col-6 text-right">
                                        - {{ \App\CentralLogics\Helpers::format_currency($coupon_discount_amount, $zone_currency) }}
                                    </dd>
                                    <dt class="col-6">{{ translate('messages.vat/tax') }}:</dt>
                                    <dd class="col-6 text-right">
                                        + {{ \App\CentralLogics\Helpers::format_currency($total_tax_amount, $zone_currency) }}</dd>
                                    <dt class="col-6">{{ translate('DM Tips') }}</dt>
                                    <dd class="col-6 text-right">
                                        + {{ \App\CentralLogics\Helpers::format_currency($deliverman_tips, $zone_currency) }}</dd>
                                    <dt class="col-6">{{ translate('Delivery Fee') }}</dt>
                                    <dd class="col-6 text-right">
                                        + {{ \App\CentralLogics\Helpers::format_currency($del_c, $zone_currency) }}</dd>
                                    <dt class="col-6">{{ translate('messages.total') }}:</dt>
                                    <dd class="col-6 text-right">
                                        {{ \App\CentralLogics\Helpers::format_currency($product_price + $del_c + $total_tax_amount + $total_addon_price + $deliverman_tips - $coupon_discount_amount - $restaurant_discount_amount, $zone_currency) }}
                                    </dd>
                                </dl>
                                <!-- End Row -->
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- End Unfold -->
                                    <!-- Static -->
                                    @if (isset($order->restaurant) && $order['order_type'] != 'take_away' && !$order->restaurant->self_delivery_system)
